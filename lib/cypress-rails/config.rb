...
module CypressRails
  class Config
    attr_accessor :rails_dir, :cypress_dir, :host, :port, :base_path, :transactional_server, :cypress_cli_opts, :server_threads
    ...
    def initialize(
      ...
      server_threads: Env.fetch("CYPRESS_RAILS_SERVER_THREADS", default: "0:4")
    )
      @rails_dir = rails_dir
    ...
    def to_s
      <<~DESC
        ...
        ============================
         ...
         CYPRESS_RAILS_SERVER_THREADS..........#{server_threads.inspect}
